...
| Session | Path | Short Description |
| --- | --- | --- |
...
Open the folder for the session you want to study, then run the Jupyter notebooks or review the project files inside it. Some sessions include an internal README with more details about setup and the practical project.

## Community

Join the Artificial Intelligence community in Syria on Telegram:
